class Instructions
  ...
  def instructions
    ...
    *********************************************************************************
    ...
    are not, I may give you another chance to guess. IF you would like to see a list
    of your guesses at any time during the game, type \"history\" If at any point your
    feeble mortal mind becomes too weak you may quit the game and slink off into your
    mortal peril by entering the command (q)uit. Continue if you dare!!!
    **********************************************************************************
